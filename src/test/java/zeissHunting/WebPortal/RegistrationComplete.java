...
import pageObjects.AccountCreateSecondPage;
...
public class RegistrationComplete {
	...
	public class ZeissIdRegistrationPage extends Base {
		...
		public void registrationCompleteNavigation(String email, String password, String reenterPass, String firstName, String lastName)
			...
			AccountCreateSecondPage accountCreateSecondPage = new AccountCreateSecondPage(driver);
			accountCreateSecondPage.getGender().selectByValue("MALE");
			Thread.sleep(10000);
		...
		public Object[][] getData() {
			...
			data[0][0] = "randomuser06@google.com";
			data[0][1] = "4inDoubleHelix!";
			data[0][2] = "4inDoubleHelix!";
			data[0][3] = "Random4";
			data[0][4] = "User04";
